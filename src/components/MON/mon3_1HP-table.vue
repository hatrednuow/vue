  ...
  <table class="main-table">
    ...
    <tr>
      <td colspan="6" style="height: 0">
        <div class="td-div">
          <template
            v-for="freezer in data.getHPDataList.STATEFREEZER"
            :key="freezer"
          >
            <ul class="freezer-ul">
        ...
        <div class="td-div">
          ...
          <div style="width: 50%">
            ...
            <div style="display: flex; height: calc(100% / 3)">
              <template
                v-for="tempWater in data.getHPDataList.TEMPWATEROUT"
                :key="tempWater"
              >
                <ul class="temp-ul">
                  <li>
            ...
            <div style="display: flex; height: calc(100% / 3)">
              <template
                v-for="tempWaterIn in data.getHPDataList.TEMPWATERIN"
                :key="tempWaterIn"
              >
                <ul class="temp-ul">
                  <li>
            ...
            <div style="display: flex; height: calc(100% / 3)">
              <template
                v-for="stateChilling in data.getHPDataList.STATECHILLING"
                :key="stateChilling"
              >
                <ul class="temp-ul">
                  <li>
          ...
          <div style="width: 50%">
            ...
            <div style="display: flex; height: calc(100% / 3)">
              <template
                v-for="tempCoolant in data.getHPDataList.TEMPCOOLANTOUT"
                :key="tempCoolant"
              >
                <ul class="temp-ul">
                  <li>
            ...
            <div style="display: flex; height: calc(100% / 3)">
              <template
                v-for="tempCoolantIn in data.getHPDataList.TEMPCOOLANTIN"
                :key="tempCoolantIn"
              >
                <ul class="temp-ul">
                  <li>
            ...
            <div style="display: flex; height: calc(100% / 3)">
              <template
                v-for="stateCooling in data.getHPDataList.STATECOOLINGWATER"
                :key="stateCooling"
              >
                <ul class="temp-ul">
                  <li>
    ...
    <tr>
      <td colspan="6" style="height: 0">
        <div class="td-div">
          <template
            v-for="coolingFen in data.getHPDataList.STATECOOLINGFEN"
            :key="coolingFen"
          >
            <ul class="freezer-ul">
    ...
    <tr>
      <td colspan="6" style="height: 0">
        <div class="td-div">
          <template
            v-for="roomTemp in data.getHPDataList.ROOMTEMP"
            :key="roomTemp"
          >
            <ul class="freezer-ul">
    ...
    <tr>
      <td colspan="6" style="height: 0">
        <div class="td-div">
          <template
            v-for="boiler in data.getHPDataList.STATEBOILER"
            :key="boiler"
          >
            <ul class="boiler-ul">
    ...
    <tr>
      <td colspan="6" style="height: 0">
        <div class="td-div">
          <template
            v-for="tempBoiler in data.getHPDataList.TEMPBOILER"
            :key="tempBoiler"
          >
            <ul class="boiler-ul">
    ...
    <tr>
      <td colspan="6" style="height: 0">
        <div class="td-div">
          <template
            v-for="heatPump in data.getHPDataList.STATEHEATPUMP"
            :key="heatPump"
          >
            <ul class="freezer-ul">
    ...
    <tr>
      <td colspan="6" style="height: 0">
        <div class="td-div">
          ...
          <div class="elec-div">
            <template v-for="gas in data.getHPDataList.GAS" :key="gas">
              <ul class="elec-ul" v-if="gas.CONTROLPOINTID == 'HP_Gas_Point'">
                <li>일</li>
    ...
    <!-- <tr>
      ...
      <td
        colspan="5"
        v-for="weather in data.getHPDataList.HP_WEATHER_TA"
        :key="weather"
      >
        {{ weather.LASTDATA }}
      </td>
...
export default {
  setup() {
    ...
    onMounted(() => {
      emitter.on("sendScadaHP", (item) => {
        data.getHPDataList = item[0];
      });
    });

    onBeforeUnmount(() => {
      emitter.off("sendScadaHP");
    });
...
.div-table > table tr:nth-child(2) {
